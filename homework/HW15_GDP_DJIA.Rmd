...
There is a strong correlation between the two variables. As the U.S. GPD increases, generally so does DJIA. The scatterplot shows this very clearly, with some areas showing a difference, but in general, as one increase, the other does as well.
