...
```{r}
spotify_songs |>
summarize(mean_danceability = mean(danceability), sd_danceability = sd(danceability))
```
...
This is a somewhat normal distribution, skewed slightly to the left. I would say this is about 70% normal. The mean, about 67%, and the standard distribution tell us that the played songs from this era were relatively upbeat and danceable, but that there were plenty of songs that weren't danceable. A story to pitch would be looking at why danceable songs were more played during this era. You could also examine the data for popularity, seeing how danceable the most popular songs are.
