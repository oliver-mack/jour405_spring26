...
I think that in general, this model is pretty useful. It's statistically significant and especially looking at points scored, we're able to see what is likely a real and meaningful impact. I would still be a bit skeptical to make sure that the variables aren't overlapping or causing the model to be worse, and also making sure that there aren't any other factors that could be influencing wins. 
...
Clearly we can see that Points scored has the most impact, with takeaways and yards gained having elss and less impact, both with moderate correlations. 
...
I think you could use this model to figure out what leads to a teams success and where the biggest issues in the team's playing are. This could be a good basis for a story to help better understand where teams are succeeding and where they're failing and what's leading to the outcomes that they have. You can also use the data to help predict which way a game might be headed based on the teams playing and their past statistics. 
